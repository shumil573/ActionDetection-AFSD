...
rgb_data_path = config['testing'].get('rgb_data_path',
                                      './datasets/thumos14/test_npy_alone/')
flow_data_path = config['testing'].get('flow_data_path',
                                       './datasets/thumos14/test_flow_npy_alone/')
...
if __name__ == '__main__':
    video_infos = get_video_info(config['dataset']['testing']['video_info_path_alone'])
    ...
    for video_name in tqdm.tqdm(list(video_infos.keys()), ncols=0):
        ...
        end_time=time.clock()
        print(video_name,end_time-start_time)
        start_time=end_time
